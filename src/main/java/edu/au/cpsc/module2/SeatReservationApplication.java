...
public class SeatReservationApplication extends Application { //basic application (base class of javaFX)
    ...
    public void start(Stage primaryStage) throws IOException { //create instance of class stage
        ...
        updateUI(flightDesignatorField, firstNameField, lastNameField, flightDatePicker, numberOfPassengersField, flyingWithInfantCheckBox);
    ...
    private void updateUI(TextField flightDesignatorField, TextField firstNameField, TextField lastNameField, DatePicker flightDatePicker, TextField numberOfPassengersField, CheckBox flyingWithInfantCheckBox) {
